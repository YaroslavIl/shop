...
// У функції initGallery
// function initGallery() {
// 	if (document.querySelector('[data-fls-gallery]')) {
// 		const gallery = lightGallery(document.querySelector('[data-fls-gallery]'), {
// 			plugins: [lgThumbnail],
// 			licenseKey: KEY,
// 			selector: '.gallery__thumb', // Селектор для мініатюр
// 			speed: 500,
// 			thumbnail: true,
// 			exThumbImage: 'data-external-thumb-image' // Тут без коментаря!
// 		})
// 	}
// }
